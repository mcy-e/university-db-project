insert into activity ( Activity_Type, reservation_id, course_id, department_id) values (1, 'lecture', 1, 1, 1);
insert into activity ( Activity_Type, reservation_id, course_id, department_id) values (4, 'practical', 4, 4, 4);
---------------------------------------------------------------------------------------------------------------------------------
insert into exam ( duration, exam_type, course_id, department_id) values (1, 39, 'midterm', 1, 1);
insert into exam ( duration, exam_type, course_id, department_id) values (4, 69, 'project', 4, 4);
----------------------------------------------------------------------------------------
